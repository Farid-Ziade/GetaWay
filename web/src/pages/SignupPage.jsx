...
export default function SignupPage() {
  ...
  function validate() {
    ...
    if (!name.trim()) errs.name = "Name is required.";
      ...
      errs.name = "Name must be 20 characters or fewer.";
    ...
    return (
      <AuthLayout>
        <div className={s.verifyBox}>
          ...
          {resendMsg && (
            <div className={`${s.alert} ${s.alertSuccess}`}>{resendMsg}</div>
          )}
          <Button
            variant="primary"
            size="lg"
  ...
  return (
    <AuthLayout>
      ...
      <p className={s.subtitle}>
        Start planning better weekends — it&apos;s free
      </p>
      ...
      <form className={s.form} onSubmit={handleSubmit} noValidate>
        <div className={s.field}>
          ...
          />
          {fieldErrors.name && (
            <span className={s.fieldError}>{fieldErrors.name}</span>
          )}
        </div>
        ...
        <div className={s.field}>
          ...
          {password && strength && (
            <div className={s.strengthBlock}>
              <div className={s.strengthRow}>
                <div
                  className={`${s.strengthBar} ${s[`level${strength.level}`]}`}
                >
                ...
                <span className={`${s.strengthLabel} ${strength.cls}`}>
                  {strength.label}
                </span>
              </div>
              <ul className={s.reqList}>
                {REQUIREMENTS.map((r) => {
                  ...
                  return (
                    <li
                      key={r.label}
                      className={`${s.reqItem} ${met ? s.reqMet : ""}`}
                    >
          ...
          {fieldErrors.password && (
            <span className={s.fieldError}>{fieldErrors.password}</span>
          )}
        </div>
        ...
        <div className={s.field}>
          ...
          {fieldErrors.confirm && (
            <span className={s.fieldError}>{fieldErrors.confirm}</span>
          )}
        </div>
